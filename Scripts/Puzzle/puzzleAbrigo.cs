...
public class puzzleAbrigo : MonoBehaviour
{
    ...
    private Vector3 resetPosicao;
     ...
     public GameObject AudioAcerto;
     public GameObject AudioErro;
    void Start()
    {
    ...
    private void OnMouseUp() {
        ...
        if(Mathf.Abs(this.transform.localPosition.x - lixeiraCorreta.transform.localPosition.x) <= 1f && 
            Mathf.Abs(this.transform.localPosition.x - lixeiraCorreta.transform.localPosition.x) <= 1f)
        {
             //som
            GameObject prefab = Instantiate(AudioAcerto, new Vector3(this.gameObject.transform.position.x, this.gameObject.transform.position.y, this.gameObject.transform.position.z), Quaternion.identity);
            //parar som
        ...
        {
             //som
            GameObject prefab = Instantiate(AudioErro, new Vector3(this.gameObject.transform.position.x, this.gameObject.transform.position.y, this.gameObject.transform.position.z), Quaternion.identity);
            //parar som
            Destroy(prefab.gameObject, 1.5f);
